...
ggplot(result6, aes(x = Year)) +
  geom_line(aes(y = Asia / 1000000000, color = 'Asia', label='Asia'), linetype = "solid") +
  geom_line(aes(y = Europe / 1000000000, color = 'Europe', label='Europe'), linetype = "solid") +
  labs(
...
-------------------------------------- SMART QUESTION 07 ---------------------------------------
Which country's environmental goods trade balance with the US has seen the greatest fluctuation from 2010 to 2022?
